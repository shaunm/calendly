            ...
            {[
              ...
              <Label key={palette.name} className="flex items-center justify-between text-base">
                ...
                <Input
                  ...
                  className="w-[92px]"
                  name={palette.name}></Input>
              </Label>
            ))}
          </div>
        </div>
        <div className="w-2/3 bg-gray-50 p-6">
          <div className={classNames(showCode ? "block" : "hidden", "h-[85vh]")}>
            <div>
              <div className="font-medium text-neutral-900">Embed Code</div>
              <p className="text-sm text-gray-500">
...
<!-- Cal inline widget end -->`}></TextArea>
          ...
          <div className={showCode ? "hidden" : "block"}>
            <iframe
              ref={iframeRef}
              className="h-[85vh]"
              width="100%"
        ...
        <WithQuery
          success={({ data }) => (
            <>
              ...
              <Dialog name="embed" clearQueryParamsOnClose={["type", "shortTitle"]}>
                {!router.query.type ? (
